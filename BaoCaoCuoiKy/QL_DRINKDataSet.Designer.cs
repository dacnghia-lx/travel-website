...
namespace CoffeeShopManagement {
    ...
    public partial class QL_DRINKDataSet : global::System.Data.DataSet {
        ...
        public partial class ADMINDataTable : global::System.Data.TypedTableBase<ADMINRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ADMINRow AddADMINRow(string MaAD, string MatKhau, string HoTen, string SoDT, byte[] Anh) {
        ...
        public partial class NHANVIENDataTable : global::System.Data.TypedTableBase<NHANVIENRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public NHANVIENRow AddNHANVIENRow(string MaNV, string HoTenNV, string DienThoai, string GioiTinh, System.DateTime NgaySinh, string ChucVu, string DiaChi, System.DateTime NgayVaoLam, byte[] Anh, bool TrangThai) {
        ...
        public partial class ADMINRow : global::System.Data.DataRow {
            ...
            public byte[] Anh {
                get {
                    try {
                        return ((byte[])(this[this.tableADMIN.AnhColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
SELECT MaAD, MatKhau, HoTen, SoDT, Anh FROM ADMIN WHERE (MaAD = @MaAD)";
        ...
        public virtual int Insert(string MaAD, string MatKhau, string HoTen, string SoDT, byte[] Anh) {
            if ((MaAD == null)) {
        ...
        public virtual int Update(string MaAD, string MatKhau, string HoTen, string SoDT, byte[] Anh, string Original_MaAD, string Original_MatKhau, string Original_HoTen, string Original_SoDT) {
            if ((MaAD == null)) {
                throw new global::System.ArgumentNullException("MaAD");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string MatKhau, string HoTen, string SoDT, byte[] Anh, string Original_MaAD, string Original_MatKhau, string Original_HoTen, string Original_SoDT) {
            return this.Update(Original_MaAD, MatKhau, HoTen, SoDT, Anh, Original_MaAD, Original_MatKhau, Original_HoTen, Original_SoDT);
        }
    }
...
SELECT MaMon, Ten, Gia, DanhMuc FROM MENU WHERE (MaMon = @MaMon)";
    ...
    public partial class NHANVIENTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[NHANVIEN] WHERE (([MaNV] = @Original_MaNV) AND ((@IsNull_HoTenNV = 1 AND [HoTenNV] IS NULL) OR ([HoTenNV] = @Original_HoTenNV)) AND ((@IsNull_DienThoai = 1 AND [DienThoai] IS NULL) OR ([DienThoai] = @Original_DienThoai)) AND ((@IsNull_GioiTinh = 1 AND [GioiTinh] IS NULL) OR ([GioiTinh] = @Original_GioiTinh)) AND ((@IsNull_NgaySinh = 1 AND [NgaySinh] IS NULL) OR ([NgaySinh] = @Original_NgaySinh)) AND ((@IsNull_ChucVu = 1 AND [ChucVu] IS NULL) OR ([ChucVu] = @Original_ChucVu)) AND ((@IsNull_DiaChi = 1 AND [DiaChi] IS NULL) OR ([DiaChi] = @Original_DiaChi)) AND ((@IsNull_NgayVaoLam = 1 AND [NgayVaoLam] IS NULL) OR ([NgayVaoLam] = @Original_NgayVaoLam)) AND ([TrangThai] = @Original_TrangThai))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_MaNV", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "MaNV", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[NHANVIEN] ([MaNV], [HoTenNV], [DienThoai], [GioiTinh], [NgaySinh], [ChucVu], [DiaChi], [NgayVaoLam], [Anh], [TrangThai]) VALUES (@MaNV, @HoTenNV, @DienThoai, @GioiTinh, @NgaySinh, @ChucVu, @DiaChi, @NgayVaoLam, @Anh, @TrangThai);
SELECT MaNV, HoTenNV, DienThoai, GioiTinh, NgaySinh, ChucVu, DiaChi, NgayVaoLam, Anh, TrangThai FROM NHANVIEN WHERE (MaNV = @MaNV)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@MaNV", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "MaNV", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[NHANVIEN] SET [MaNV] = @MaNV, [HoTenNV] = @HoTenNV, [DienThoai] = @DienThoai, [GioiTinh] = @GioiTinh, [NgaySinh] = @NgaySinh, [ChucVu] = @ChucVu, [DiaChi] = @DiaChi, [NgayVaoLam] = @NgayVaoLam, [Anh] = @Anh, [TrangThai] = @TrangThai WHERE (([MaNV] = @Original_MaNV) AND ((@IsNull_HoTenNV = 1 AND [HoTenNV] IS NULL) OR ([HoTenNV] = @Original_HoTenNV)) AND ((@IsNull_DienThoai = 1 AND [DienThoai] IS NULL) OR ([DienThoai] = @Original_DienThoai)) AND ((@IsNull_GioiTinh = 1 AND [GioiTinh] IS NULL) OR ([GioiTinh] = @Original_GioiTinh)) AND ((@IsNull_NgaySinh = 1 AND [NgaySinh] IS NULL) OR ([NgaySinh] = @Original_NgaySinh)) AND ((@IsNull_ChucVu = 1 AND [ChucVu] IS NULL) OR ([ChucVu] = @Original_ChucVu)) AND ((@IsNull_DiaChi = 1 AND [DiaChi] IS NULL) OR ([DiaChi] = @Original_DiaChi)) AND ((@IsNull_NgayVaoLam = 1 AND [NgayVaoLam] IS NULL) OR ([NgayVaoLam] = @Original_NgayVaoLam)) AND ([TrangThai] = @Original_TrangThai));
SELECT MaNV, HoTenNV, DienThoai, GioiTinh, NgaySinh, ChucVu, DiaChi, NgayVaoLam, Anh, TrangThai FROM NHANVIEN WHERE (MaNV = @MaNV)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@MaNV", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "MaNV", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT MaNV, HoTenNV, DienThoai, GioiTinh, NgaySinh, ChucVu, DiaChi, NgayVaoLam, " +
                "Anh, TrangThai FROM dbo.NHANVIEN";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(string Original_MaNV, string Original_HoTenNV, string Original_DienThoai, string Original_GioiTinh, global::System.Nullable<global::System.DateTime> Original_NgaySinh, string Original_ChucVu, string Original_DiaChi, global::System.Nullable<global::System.DateTime> Original_NgayVaoLam, bool Original_TrangThai) {
            if ((Original_MaNV == null)) {
            ...
            this.Adapter.DeleteCommand.Parameters[15].Value = ((bool)(Original_TrangThai));
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.DeleteCommand.Connection.State;
            if (((this.Adapter.DeleteCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                this.Adapter.DeleteCommand.Connection.Open();
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string MaNV, string HoTenNV, string DienThoai, string GioiTinh, global::System.Nullable<global::System.DateTime> NgaySinh, string ChucVu, string DiaChi, global::System.Nullable<global::System.DateTime> NgayVaoLam, byte[] Anh, bool TrangThai) {
            if ((MaNV == null)) {
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[25].Value = ((bool)(Original_TrangThai));
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.UpdateCommand.Connection.State;
            if (((this.Adapter.UpdateCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                this.Adapter.UpdateCommand.Connection.Open();
        ...
        public virtual int Update(
                    ...
                    global::System.Nullable<global::System.DateTime> Original_NgayVaoLam, 
                    bool Original_TrangThai) {
            return this.Update(Original_MaNV, HoTenNV, DienThoai, GioiTinh, NgaySinh, ChucVu, DiaChi, NgayVaoLam, Anh, TrangThai, Original_MaNV, Original_HoTenNV, Original_DienThoai, Original_GioiTinh, Original_NgaySinh, Original_ChucVu, Original_DiaChi, Original_NgayVaoLam, Original_TrangThai);
        }
    }
